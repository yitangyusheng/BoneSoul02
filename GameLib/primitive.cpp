...
namespace GameLib
{
        ...
        ) const
    {
        ...
        vertices[0] = { VECTOR3(-0.0f, +1.0f, 0), color };
        vertices[1] = { VECTOR3(+1.0f, +1.0f, 0), color };
        vertices[2] = { VECTOR3(-0.0f, -0.0f, 0), color };
        vertices[3] = { VECTOR3(+1.0f, -0.0f, 0), color };
#else
        ...
        const VECTOR2(&v)[4], const VECTOR4& color) const
    {
        ...
        vertex vertices[4]{};
#ifdef GAMELIB_PLUS_UP
        vertices[0] = { VECTOR3(v[3].x, v[3].y, 0), color };
        vertices[1] = { VECTOR3(v[2].x, v[2].y, 0), color };
        vertices[2] = { VECTOR3(v[0].x, v[0].y, 0), color };
        vertices[3] = { VECTOR3(v[1].x, v[1].y, 0), color };
#else
        vertices[0] = { VECTOR3(v[0].x, v[0].y, 0), color };
        vertices[1] = { VECTOR3(v[1].x, v[1].y, 0), color };
        vertices[2] = { VECTOR3(v[3].x, v[3].y, 0), color };
        vertices[3] = { VECTOR3(v[2].x, v[2].y, 0), color };
#endif
...
#ifdef GAMELIB_PLUS_UP
        instances[instanceCount].ndcTransform._21 = -instances[instanceCount].ndcTransform._21;
        instances[instanceCount].ndcTransform._22 = -instances[instanceCount].ndcTransform._22;
        instances[instanceCount].ndcTransform._24 = -instances[instanceCount].ndcTransform._24;
#endif
